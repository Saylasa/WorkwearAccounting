...
namespace WorkwearAccounting
{
    ...
    public partial class SettingsWindow : Window
    {
        ...
        {
            if (ProcessFactory.GetSettingProcess().GetSettings() != null)
            {
                SqlConnectionStringBuilder builder = new SqlConnectionStringBuilder();
                builder.ConnectionString = ProcessFactory.GetSettingProcess().GetSettings();
        ...
        {
            if (ProcessFactory.GetSettingProcess().SetSettings(this.tbServer.Text, this.tbDataBase.Text, this.tbUser.Text, this.tbPassword.Text))
            {
